...
local watermark_items = {
	{
		...
		get_width = function(self, frame_data)
			self.game_width = renderer_measure_text(nil, "gameskeet ")
			self.sense_width = renderer_measure_text(nil, "v2 crack")
		...
		draw = function(self, x, y, w, h, r, g, b, a)
			...
			renderer_text(x, y, 255, 255, 255, a, nil, 0, "gameskeet ")
			renderer_text(x+self.game_width, y, r_sense, g_sense, b_sense, a, nil, 0, "v2 crack")
			if is_beta then
